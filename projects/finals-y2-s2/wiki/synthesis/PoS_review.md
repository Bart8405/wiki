...
**Definition:** The idiographic approach aims to understand the *particular* — the unique characteristics, meaning, and context of a specific case, event, person, or text. It is the characteristic mode of the human sciences (history, literary studies, philosophy). Windelband coined "idiographic" and "nomothetic" around 1894 to argue that the natural-vs-human-science divide is about a *choice of approach*, not just a choice of topic: the same object (a society, a psyche) can be studied either way.

**Explained easily:** A physicist studying a falling apple wants a law that applies to every apple everywhere (nomothetic). A historian studying the French Revolution wants to understand *what made this revolution specific* — its causes, actors, timing, contingencies (idiographic). Neither is more "scientific" than the other; they just have different ideas of what counts as knowing well.
...
**Definition:** The Dutch *stikstofcrisis* (nitrogen crisis) is an ongoing environmental and political crisis in the Netherlands. Decades of intensive livestock farming produced ammonia emissions that violated EU Natura 2000 habitat protection laws. Court rulings in 2019–2021 ordered dramatic livestock reductions, triggering large-scale farmer protests (tractors blockading highways), political upheaval, and the rise of a farmers' party (BoerBurgerBeweging, which became the largest party in Senate elections).
...
| Term | One-liner |
|---|---|
| correspondence theory of truth | A proposition is true iff there's a matching fact in the world (Russell) |
| facts as truthmakers | Facts make propositions true; facts themselves just *are* |
| Gettier problem | You can have JTB without knowledge — the broken-clock case |

---

### correspondence theory of truth + facts as truthmakers
*(Russell — these form a single picture of how truth works)*

**Correspondence theory of truth:** A proposition is true if and only if there is a fact in the world that corresponds to it. "Snow is white" is true because snow actually is white — the world makes it true, not your mind. Bertrand Russell (1910s) is the main modern advocate. The key alternatives (not this lecture's focus) are the coherence theory (truth = fits a consistent web of beliefs) and pragmatism (truth = what works in practice).

**Facts as truthmakers / propositions as truth-bearers:** Propositions are the linguistic things that *can* be true or false ("Snow is white"). Facts are states of affairs in the world ("the state of snow being white") — they're not true or false, they just *exist*. A fact *makes* the corresponding proposition true. The lecture's analogy: think of facts like planets — they're just out there. Sentences about planets can be true or false; the planets themselves aren't.
...
**Definition:** Edmund Gettier (1963) showed that the classical JTB (Justified True Belief) account of knowledge is insufficient. You can tick all three boxes — the belief is true, you hold it, and you're justified — and still not *know*. The classic type of case: you look at a clock that has stopped, and it happens to show the correct time. You have a justified belief (the clock says 3:15), it's true (it is 3:15), but you don't *know* — you just got lucky. The belief's truth is accidental relative to your justification.
...
| Term | One-liner |
|---|---|
| regularity view vs necessity view of laws | Are laws just patterns we observe, or do they describe what *must* be? |
| induction + deduction + ampliative reasoning | Induction adds knowledge beyond premises; deduction just extracts what's already there |
| problem of induction + pragmatic warrant | Hume: can't justify induction; Reichenbach: it's still the rational bet |
| Duverger's law | FPTP → two-party system; PR → multi-party; example of a law in political science |

---

### regularity view vs necessity view of laws

**Regularity view:** Laws are just descriptions of what we observe happening — consistently, universally. "All ravens are black" becomes a law if it holds without exception everywhere. Nothing is "built into" reality forcing it — we just observe the pattern and call it a law. (Associated with Hume.)

**Necessity view:** Some regularities are *necessary* — they couldn't be otherwise given the nature of the world. Others are *accidental* (e.g. all coins in my pocket happen to be silver right now — true but not a law). Laws capture the necessary regularities. Knowing a law tells you not just what *does* happen but what *must* happen.
...
### induction + deduction + ampliative reasoning
*(core reasoning concepts — your question was about ampliative)*

**Induction:** Reasoning from specific observations to a general conclusion. *"Swan 1 is white, swan 2 is white… swan 1000 is white → all swans are white."* Goes upward from cases to a universal claim.

**Deduction:** Reasoning from a general principle to a specific conclusion. *"All humans are mortal; Socrates is human → Socrates is mortal."* If premises are true, the conclusion is guaranteed — logically necessary.

**Ampliative reasoning:** Reasoning whose conclusion contains MORE information than the premises — it goes *beyond* what was given. Induction is ampliative; deduction is not.
...
*(Hume's problem and Reichenbach's response — keep these together)*

**Problem of induction (Hume):** We cannot logically justify using induction. Hume's argument comes in two halves:
- Try to justify induction *inductively*: "Induction has worked in the past → induction will work in the future." But this is itself an inductive argument — you're using induction to prove induction works. Circular (and an infinite regress if you try to justify that justification).
- Try to justify induction *deductively*: You'd need a principle like "the future will resemble the past" — but there's no logical proof of this. It isn't an analytic truth (it's not *contradictory* to imagine the sun not rising tomorrow). And you can't derive it from experience without using induction again.
- **Hume's conclusion:** no justification exists. Induction is a *psychological habit* — we're wired to expect patterns to continue, but there's no rational warrant for it.

**Pragmatic warrant (Reichenbach & Braithwaite):** Accept Hume's verdict — there's no logical proof. But argue: *if* the world has regularities, induction will find them as fast as any other method. *If* the world has no regularities, then nothing will work — no method can predict anything. So we lose nothing by using induction. It's the rational bet even without a logical guarantee.

**Your question:** Describe how we should justify induction inductively and deductively
**Answer:** These are actually the two paths Hume shows *don't work*:
...
**Definition:** Political scientist Maurice Duverger (1950s) observed that plurality-rule electoral systems tend to produce two-party systems (UK, US), while proportional representation tends to produce multi-party systems (Netherlands, Belgium, Sweden). It's one of the best-known law-like generalisations in political science — though debated as to whether it's a true law or a strong tendency.
